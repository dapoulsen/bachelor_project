...
<div class="max-w-3xl mx-auto p-6 bg-gray-900 text-white rounded-lg shadow-lg">
    ...
    <div  class="flex items-center space-x-2 mb-4">
        <input 
            ...
            class="w-full p-3 rounded-lg bg-gray-800 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 transition-all duration-200 ease-in-out"
        />
        <button 
